...
$(document).ready(function(){
	$.ajax({
		type:"get",
//		url:"http://192.168.43.230:8081/common/assignee",
		url:"http://192.168.20.168:8080/common/assignee",
		async:true,
		dataType:'json',
...
function nameDate(){
	...
	if(endTime!=''&&assignee!=''){
					$.ajax({
							type:"post",
//							url:"http://192.168.43.230:8081/person/efficiency",
							url:"http://192.168.20.168:8080/person/efficiency",
							async:true,
							data:{
								assignee:assignee,
								endTime:endTime
